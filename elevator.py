...
class Elevator(object):
	...
	def gateOpen(self,count):
		self.window.coords(self.body1,self.x+25-count,self.y,self.x+25+count,self.y+90)
		# self.window.coords(self.body2,self.x+25,self.y,self.x+25+count,self.y+90)

	def gateClose(self,count):
		self.window.coords(self.body1,self.x+count,self.y,self.x+50-count,self.y+90)
